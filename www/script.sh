...
sed -i "11i <p style='font-weight:normal;color:#E6E6E6;background-color:#000000;letter-spacing:0.3pt;word-spacing:1.2pt;font-size:10px;text-align:left;font-family:tahoma, verdana, arial, sans-serif;line-height:1;margin:0px;padding:0px;'>" /var/www/pifm.log.htm
